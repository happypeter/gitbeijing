...
![](https://github.com/happypeter/gitbeijing/blob/master/data/posts/images/fork_flow/flow.png?raw=true)
...
![](https://github.com/happypeter/gitbeijing/blob/master/data/posts/images/fork_flow/fork.png?raw=true)

这样，我自己的名下就多了一个 TLCL 项目，这个项目就叫做原项目的一个 fork 。

![](https://github.com/happypeter/gitbeijing/blob/master/data/posts/images/fork_flow/my_fork.png?raw=true)
...
![](https://github.com/happypeter/gitbeijing/blob/master/data/posts/images/fork_flow/cloning.png?raw=true)
...
![](https://github.com/happypeter/gitbeijing/blob/master/data/posts/images/fork_flow/my_commit.png?raw=true)
...
![](https://github.com/happypeter/gitbeijing/blob/master/data/posts/images/fork_flow/new_pr.png?raw=true)

如上图，点一下项目页面右侧的 `Pull Request` 链接，到达的页面中会有一个大大的绿按钮 `New Pull Request`，点一下就看到下面的页面

![](https://github.com/happypeter/gitbeijing/blob/master/data/posts/images/fork_flow/new_pr_view.png?raw=true)

注意上面 1 处，要选对是哪两个分支进行对比，左侧是上游分支，也就是“目的地”分支，右侧是我自己的分支，有修改的内容。有时候 github 能猜对拿哪两个分支做对比，有时候就要自己手动选择一下。分支要是选得不对那么 2 处对比出来的代码肯定也会有问题的，所以还是比较容易看出来的。下面就可以点 3 处的大按钮来发 PR 了。之后，在 billie66/TLCL 下面，注意不是 happypeter/TLCL 下面，就会看到这个 PR 。

![](https://github.com/happypeter/gitbeijing/blob/master/data/posts/images/fork_flow/final_pr.png?raw=true)
...
![](https://github.com/happypeter/gitbeijing/blob/master/data/posts/images/fork_flow/delete_repo.png?raw=true)
...
![](https://github.com/happypeter/gitbeijing/blob/master/data/posts/images/fork_flow/network.png?raw=true)
...
![](https://github.com/happypeter/gitbeijing/blob/master/data/posts/images/fork_flow/fork_quick_pr.png?raw=true)
